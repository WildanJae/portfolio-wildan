...
export default function PlayFlappyPage() {
  ...
  return (
    <main className="min-h-screen bg-background relative overflow-hidden py-24 px-[5%] flex flex-col">
      <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-yellow-500/10 rounded-full blur-[150px] pointer-events-none" />
